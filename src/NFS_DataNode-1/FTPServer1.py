...
USERNAME = 'user'
PASSWORD = '12345'
HOME_DIR = r'/Users/abhishekadityabs/Distributed Systems/PyNFS/src/NFS_DataNode-1'
...
def main():
    ...
    print(Fore.GREEN + "FTP SERVER FOR DATA NODE (1) - CONFIGURATION" + Fore.RESET)
    print("-"*50)
    ...
    print("\n")
    print(Fore.GREEN + "FTP SERVER FOR DATA NODE (1) - LOGS" + Fore.RESET)
    print("-"*50)
    server.serve_forever()

def stopFTP():
    print(Fore.RED + "FTP SERVER FOR DATA NODE (1) - STOPPED" + Fore.RESET)
    server.close_all()
