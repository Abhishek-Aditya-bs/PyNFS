...
IP_ADDR = "127.0.0.1"
PORT_NUM = 8000
DIR_PATH = r'/Users/abhishekadityabs/Distributed Systems/PyNFS/src/NFS_DataNode-2'
FTP_ADDR = "127.0.0.1"
...
if __name__ == "__main__":
    print(Fore.GREEN + "DATA NODE (2) - CONFIGURATION " + Fore.RESET)
    print("-"*50)
    print("Data Node (2) IP: " + Fore.YELLOW + IP_ADDR + Fore.RESET)
    print("Data Node (2) Port: " + Fore.YELLOW + str(PORT_NUM) + Fore.RESET)
    print("Data Node (2) Directory Path: " + Fore.YELLOW + DIR_PATH + Fore.RESET)
    print("\n")
    print(Fore.GREEN + "DATA NODE (2) - LOGS" + Fore.RESET)
    print("-"*50)
